...
@Of public final class SaCvaParameters {
  ...
  static SaCvaParameters create(double mCva,double creditSpreadVegaRw,double girrDeltaRw,double girrVegaRw,double fxDeltaRw,double fxVegaRw,double creditSpreadRho,double creditSpreadGamma,double fxGamma,Map<String,Double> creditSpreadRw){return new SaCvaParameters(mCva,creditSpreadVegaRw,girrDeltaRw,girrVegaRw,fxDeltaRw,fxVegaRw,creditSpreadRho,creditSpreadGamma,fxGamma,creditSpreadRw);}
  ...
  public double withinBucketCorrelation(RiskClass c){return c==RiskClass.CSR_NON_SEC?creditSpreadRho:.99;}
  public double acrossBucketCorrelation(RiskClass c){return switch(c){case CSR_NON_SEC->creditSpreadGamma;case FX->fxGamma;default->0;};}
}
