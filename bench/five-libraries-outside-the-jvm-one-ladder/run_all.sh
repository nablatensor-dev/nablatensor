...
# MatLogica AADC needs its own venv (see README) and is not run by this script:
#   row $PY matlogica_bench.py european 20000000
#   row $PY matlogica_bench.py european 20000000 greeks
#   row $PY matlogica_bench.py european 20000000 cached
#   row $PY matlogica_bench.py european 20000000 greeks cached
#   row $PY matlogica_bench.py asian 200000
#   row $PY matlogica_bench.py asian 200000 greeks
#   row $PY matlogica_bench.py asian 200000 cached
#   row $PY matlogica_bench.py asian 200000 greeks cached
